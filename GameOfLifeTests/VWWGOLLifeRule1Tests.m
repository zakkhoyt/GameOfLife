...
- (void)testRule1a
{
    ...
    XCTAssertFalse([self.life cellPassesRule1:cell], @"failed to pass test for rule 1. %s", __func__);
    ...
    XCTAssertTrue([self.life cellPassesRule1:cell], @"failed to pass test for rule 1. %s", __func__);
