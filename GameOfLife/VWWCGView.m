...
//    self.backgroundColor = [UIColor clearColor];
    ...
    CGFloat cellWidth = self.bounds.size.width / self.physics.width;
    CGFloat cellHeight = self.bounds.size.height / self.physics.height;
...
//    }
    ...
    for(VWWGOLCell *cell in self.physics.cells){
        [cell.color getRed:&red green:&green blue:&blue alpha:&alpha];
        CGContextSetRGBFillColor(context, red, green, blue, alpha);
